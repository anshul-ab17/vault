          ...
          <div className="flex flex-col items-center w-full gap-3">
            ...
            <div className="flex flex-col gap-1 w-full items-center">
              ...
              <p className="text-zinc-500 text-sm text-center">
                ...
                <Link className="text-blue-600 hover:underline font-medium" href="/signin">
                  Sign in
                </Link>
              </p>
            </div>
          ...
          <div className="flex flex-col w-full gap-3.5">
            ...
            >
              <svg className="w-4 h-4 shrink-0" viewBox="0 0 397.7 311.7">
                <linearGradient id="signup-sol-1" x1="56.7" y1="289.4" x2="340.9" y2="289.4" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#00FFA3" />
                  <stop offset="1" stopColor="#DC1FFF" />
                </linearGradient>
                <path fill="url(#signup-sol-1)" d="M64.6 237.9c2.4-2.4 5.7-3.8 9.2-3.8h317.4c5.8 0 8.7 7 4.6 11.1l-62.7 62.7c-2.4 2.4-5.7 3.8-9.2 3.8H6.5c-5.8 0-8.7-7-4.6-11.1l62.7-62.7z" />
                <linearGradient id="signup-sol-2" x1="56.7" y1="155.9" x2="340.9" y2="155.9" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#00FFA3" />
                  <stop offset="1" stopColor="#DC1FFF" />
                </linearGradient>
                <path fill="url(#signup-sol-2)" d="M64.6 3.8C67 1.4 70.3 0 73.8 0h317.4c5.8 0 8.7 7 4.6 11.1l-62.7 62.7c-2.4 2.4-5.7 3.8-9.2 3.8H6.5c-5.8 0-8.7-7-4.6-11.1L64.6 3.8z" />
                <linearGradient id="signup-sol-3" x1="56.7" y1="22.6" x2="340.9" y2="22.6" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#00FFA3" />
                  <stop offset="1" stopColor="#DC1FFF" />
                </linearGradient>
                <path fill="url(#signup-sol-3)" d="M333.1 120.8c-2.4-2.4-5.7-3.8-9.2-3.8H6.5c-5.8 0-8.7 7-4.6 11.1l62.7 62.7c2.4 2.4 5.7 3.8 9.2 3.8h317.4c5.8 0 8.7-7 4.6-11.1l-62.7-62.7z" />
              </svg>
